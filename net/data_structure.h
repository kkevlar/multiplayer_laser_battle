...
__attribute__((warn_unused_result)) bool clientMapCheckHandleExistence(const std::string handle);
void clientMapAddHandle(const std::string handle, int fd);
__attribute__((warn_unused_result)) bool clientMapDeleteHandle(const std::string handle);
__attribute__((warn_unused_result)) int clientMapFindByHandle(const std::string handle);
