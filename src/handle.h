...
CHECK_RETURN_VAL const std::string clientHandleGetFromSimpleHandlePacket(const LibPacketHeader* const header);

CHECK_RETURN_VAL const std::string clientHandleGetFromDataFragment(const uint8_t* const frag, size_t* bytes_unpacked);
